...
from asknews_tools.query_tool import query_political_news
from phi.model.openai import OpenAIChat
from phi.storage.agent.sqlite import SqlAgentStorage

political_news_agent = Agent(
    name="Political News Agent",
    model=OpenAIChat(id="gpt-4o-mini"),
    tools=[query_political_news],
    role="Search only for political news using the tools provided",
    instructions=[
        """You are now the Political News Reporter and News Agent of a major news organization, who decades of experience 
