...
from asknews_tools.query_tool import query_climate_news
from phi.model.openai import OpenAIChat
from phi.storage.agent.sqlite import SqlAgentStorage

climate_news_agent = Agent(
    name="Climate News Agent",
    model=OpenAIChat(id="gpt-4o-mini"),
    tools=[query_climate_news],
    role="Search only for climate news using the tools provided",
    instructions=[
        """You are now the Climate News Reporter and News Agent of a major news organization, who decades of experience 
