...
from asknews_tools.query_tool import query_science_and_tech_news
from phi.model.openai import OpenAIChat
from phi.storage.agent.sqlite import SqlAgentStorage

science_and_technology_news_agent = Agent(
    name="Science and Technology News Agent",
    model=OpenAIChat(id="gpt-4o-mini"),
    tools=[query_science_and_tech_news],
    role="Search only for science and technology news using the tools provided",
    instructions=[
        """You are now the Science and Technology News Reporter and News Agent of a major news organization, who decades of experience 
