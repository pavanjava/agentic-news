...
from asknews_tools.query_tool import query_health_news
from phi.model.openai import OpenAIChat
from phi.storage.agent.sqlite import SqlAgentStorage

health_news_agent = Agent(
    name="Health News Agent",
    model=OpenAIChat(id="gpt-4o-mini"),
    tools=[query_health_news],
    role="Search only for health news using the tools provided",
    instructions=[
        """You are now the Health News Reporter and News Agent of a major news organization, who decades of experience 
