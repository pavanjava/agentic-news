...
from asknews_tools.query_tool import query_crime_news
...
crime_news_agent = Agent(
    ...
    tools=[query_crime_news],
    role="Search only for crime news using the tools provided",
    instructions=[
        """You are now the Crime News Reporter and News Agent of a major news organization, who decades of experience 
